...
![AutoWiki repository list in the Factory App](/images/wiki/autowiki-list.png)

Open a repository to read generated pages with navigation, page outlines, search, export, and refresh controls.

![AutoWiki reader showing generated architecture documentation](/images/wiki/autowiki-reader.png)
...
![Batch refresh selection mode in AutoWiki](/images/wiki/autowiki-batch-refresh.png)
