...
| 16   | **Grok 4.5**                             | Newest xAI Grok model with mixed reasoning (Low/Medium/High); strong frontier option at a cost-efficient 0.8× multiplier.                                   |
| 17   | **Gemini 3.1 Pro**                       | Newer Gemini Pro generation with strong structured outputs and mixed reasoning controls for research-heavy tasks.                                           |
| 18   | **Gemini 3 Flash**                       | Fast, cheap (0.2× multiplier) with full reasoning support; great for high-volume tasks where speed matters.                                                 |
| 19   | **Droid Core (NVIDIA Nemotron 3 Ultra)** | Open-source, 0.4× multiplier, fast and cost-efficient model for high-frequency automations; no image support.                                               |
...
| 24   | **Droid Core (Kimi K2.7 Code)**          | Coding-specialized Kimi at 0.4× with optional High reasoning; strong agentic and tool use for cost-sensitive dev work.                                      |
| 25   | **Droid Core (Kimi K2.6)**               | Open-source, 0.4× multiplier with image support and optional High reasoning; good for cost-sensitive work when you still want a thinking toggle.            |
| 26   | **Droid Core (Kimi K2.5)**               | Open-source, 0.25× multiplier with image support; older Kimi option for cost-sensitive work.                                                                |
