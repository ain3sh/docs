...
| 24   | **Droid Core (GLM-5.2)**                 | Open-source, 0.55× multiplier, newest GLM option for bulk automation and air-gapped environments; no image support.                                          |
| 25   | **Droid Core (GLM-5.1)**                 | Open-source, 0.55× multiplier, newer GLM option for bulk automation and air-gapped environments; no image support.                                          |
| 26   | **Droid Core (GLM-5)**                   | Open-source, 0.4× multiplier, stable choice for bulk automation and air-gapped environments; no image support.                                              |
| 27   | **Droid Core (Kimi K2.7 Code)**          | Coding-specialized Kimi at 0.4× with optional High reasoning; strong agentic and tool use for cost-sensitive dev work.                                      |
| 28   | **Droid Core (Kimi K2.6)**               | Open-source, 0.4× multiplier with image support and optional High reasoning; good for cost-sensitive work when you still want a thinking toggle.            |
| 29   | **Droid Core (Kimi K2.5)**               | Open-source, 0.25× multiplier with image support; older Kimi option for cost-sensitive work.                                                                |
...
**Droid Core (GLM-5.2)**, **Droid Core (GLM-5)**, **Droid Core (GLM-5.1)**, **Droid Core (Kimi K2.6)**, **Droid Core (Kimi K2.5)**, and **Droid Core (MiniMax M2.7)** are open-source alternatives available in the CLI. They're useful for:
...
**Note:** GLM-5, GLM-5.1, and GLM-5.2 do not support image attachments. Kimi K2.5, Kimi K2.6, and MiniMax M2.7 do support images. Kimi K2.6 adds an Off/High reasoning toggle, while MiniMax M2.7 (the cheapest model available, with 0.12× multiplier) supports Low/Medium/High reasoning. For image-based workflows, use Claude, GPT, Kimi, or MiniMax M2.7.
