...
You can also use `/install-github-app` for GitHub-only setup. For detailed setup instructions, see the [GitHub App installation guide](/integrations/github-app).
...
- [GitHub App installation](/integrations/github-app) - Full setup guide for `/install-github-app`
