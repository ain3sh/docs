...
<Info>
  **Using Factory App?** Most of this guide applies to both the Droid CLI and the [Factory App](/web/getting-started/overview). Where the experience differs, we've noted the Factory App-specific approach.
</Info>
