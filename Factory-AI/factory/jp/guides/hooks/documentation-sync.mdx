...
<Steps>
  ...
  <Step title="ドキュメントをコードにリンクする">
    ...
    ソース: [`src/components/Button.tsx`](../src/components/Button.tsx)
    ```
  </Step>
...
- [フックの始め方](/jp/cli/configuration/hooks-guide) - 基本的なフックの紹介
- [コード検証](/jp/guides/hooks/code-validation) - コード標準の強制
- [Gitワークフロー](/jp/guides/hooks/git-workflows) - Git統合
