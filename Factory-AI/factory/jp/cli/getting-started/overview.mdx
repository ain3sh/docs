...
- **Missions**: オーケストレーターが専門のワーカー Droid を編成し、より大きな機能の計画・実装・検証を行うマルチエージェントプロジェクトを起動します。`/missions` で開始するか、`droid exec --mission` でヘッドレス実行できます。[詳細 →](/jp/cli/features/missions)
