...
- **安全チェック** – denylistにある危険なコマンドはHighでも確認を求めます。`$(...)`やバッククォート内にネストされた危険なコマンドも含まれます。[サンドボックス](/jp/cli/configuration/sandbox)の読み取り・書き込み・ネットワークチェックでも別途プロンプトが表示される場合があります。
