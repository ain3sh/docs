...
| `--mission`                          | `droid exec` を [ミッションモード](/jp/cli/features/missions)（マルチエージェントオーケストレーション）で実行 | `droid exec --mission -f mission.md`                       |
...
| フラグ                       | 説明                                                                                  | 例                                                              |
| :------------------------- | :---------------------------------------------------------------------------------- | :--------------------------------------------------------------- |
| `--type <type>`            | サーバーのトランスポート: `http`（ストリーミングHTTP）または `stdio`（ローカル）                    | `droid mcp add api https://api.example.com/mcp --type http`      |
