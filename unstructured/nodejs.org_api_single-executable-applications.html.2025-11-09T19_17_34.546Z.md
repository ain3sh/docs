...
# Node.js v25.1.0 documentation

- Node.js v25.1.0
- [Table of contents](https://nodejs.org/api/single-executable-applications.html#toc-picker)




- [Single executable applications](https://nodejs.org/api/single-executable-applications.html#single-executable-applications)
  - [Generating single executable preparation blobs](https://nodejs.org/api/single-executable-applications.html#generating-single-executable-preparation-blobs)
  ...
  - [In the injected main script](https://nodejs.org/api/single-executable-applications.html#in-the-injected-main-script)
    ...
    - [`require(id)` in the injected main script is not file based](https://nodejs.org/api/single-executable-applications.html#requireid-in-the-injected-main-script-is-not-file-based)
...
- [Index](https://nodejs.org/api/single-executable-applications.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/api/single-executable-applications.html#alt-docs)


1. [25.x](https://nodejs.org/docs/latest-v25.x/api/single-executable-applications.html)
2. [24.x](https://nodejs.org/docs/latest-v24.x/api/single-executable-applications.html)
...
- [Options](https://nodejs.org/api/single-executable-applications.html#options-picker)


- [View on single page](https://nodejs.org/api/all.html)
- [View as JSON](https://nodejs.org/api/single-executable-applications.json)
...
**Source Code:** [src/node\_sea.cc](https://github.com/nodejs/node/blob/v25.1.0/src/node_sea.cc)
...
single embedded script using the [CommonJS](https://nodejs.org/api/modules.html#modules-commonjs-modules) module system.
...
[Generating single executable preparation blobs](https://nodejs.org/api/single-executable-applications.html#generating-single-executable-preparation-blobs) for details):
...
properties that non-injected [`require()`](https://nodejs.org/api/modules.html#requireid) has except [`require.main`](https://nodejs.org/api/modules.html#accessing-the-main-module). It
